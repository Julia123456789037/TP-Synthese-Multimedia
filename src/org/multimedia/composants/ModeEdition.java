...
public enum ModeEdition {
	...
	SELECTION_RECT  (getCursor("/plus.png", new Point(0, 0))),  // TODO: Changer les coordonnées de la pointe.
	SELECTION_ROND  (getCursor("/plus.png", new Point(0, 0)));  // TODO: Changer les coordonnées de la pointe.
